...
#send the build folder
    copy_folders_to_front_end("D:\\Personal\\Development\\BlockChainDevelopment\\DEFI-STAKE-YIELD-BROWNIE\\build",
    "D:\\Personal\\Development\\BlockChainDevelopment\\DEFI-STAKE-YIELD-BROWNIE\\front_end\src\\chain-info")
#

    with open("D:\Personal\Development\BlockChainDevelopment\DEFI-STAKE-YIELD-BROWNIE\\brownie-config.yaml", "r") as brownie_config:
        config_dict = yaml.load(brownie_config, Loader=yaml.FullLoader)
        with open("D:\\Personal\\Development\\BlockChainDevelopment\\DEFI-STAKE-YIELD-BROWNIE\\front_end\\src\\brownie-config.json", "w") as brownie_config_json:
